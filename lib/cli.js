...
proto.spawn = function(port) {
  ...
  var driver = new Driver(null, this.options.bundle, this.options.browserify)
...
proto.client = function(driver_url) {
  ...
  var parsed = url.parse(!isNaN(driver_url) ? 'http://localhost:'+driver_url+'/' : driver_url)
    , rest = this.get_tests()
    , client = new Client(this, rest, this.options.browserify)
...
proto.local = function() {
  ...
  var self = this
    , port = 9000
    , driver = new Driver(null, this.options.bundle, this.options.browserify)
  ...
  function got_env() {
    var client = new Client(self, self.options.argv.remain, this.options.browserify)
      , rest = self.get_tests()
