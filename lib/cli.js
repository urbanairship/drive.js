...
proto.local = function() {
  ...
  var self = this
    , port = 9000
    , driver = new Driver(null, this.options.bundle, this.get_config())
  ...
  function got_env() {
    var client = new Client(self, self.options.argv.remain, self.options.browserify, this.options.transform, this.options.noparse, this.options.dep)
      , rest = self.get_tests()
