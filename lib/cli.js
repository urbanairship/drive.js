...
proto.client = function(driver_url) {
  ...
  var parsed = url.parse(!isNaN(driver_url) ? 'http://localhost:'+driver_url+'/' : driver_url)
    , rest = this.get_tests()
    , client = new Client(this, rest, this.options.browserify, this.options.transform, this.options.noparse)
...
proto.local = function() {
  ...
  function got_env() {
    var client = new Client(self, self.options.argv.remain, self.options.browserify, this.options.transform, this.options.noparse)
      , rest = self.get_tests()
