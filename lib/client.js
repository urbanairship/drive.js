...
function Client(dnode, conn, browserify, browserify_transforms, browserify_noparse) {
...
function Local(cli, files) {
  ...
  this.browserify_transforms = cli.options.transforms || []
  this.files = files
...
proto.dnodify = function() {
  var out = {}
  out.for_browserify = this.browserify
