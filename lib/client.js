...
function Client(dnode, conn, browserify, browserify_transforms, browserify_noparse, browserify_deps, browserify_requires) {
  this.browserify = browserify
  this.browserify_transforms = browserify_transforms
  this.browserify_noparse = browserify_noparse
  this.browserify_deps = browserify_deps
  this.browserify_requires = browserify_requires
  this.dnode = dnode
...
function Local(cli, files) {
  ...
  this.browserify_noparse = cli.options.noparse || []
  this.browserify_transforms = cli.options.transform || []
  this.browserify_deps = cli.options.entry || []
  this.browserify_requires = cli.options.require || []
  this.files = files
