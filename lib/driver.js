...
proto.build_browserify = function (transforms, no_parse, test_files, uuid, ready) {
  var b = browserify({ insertGlobals: true, debug: true, noParse: no_parse })
    , self = this
  // get rid of these, instead add flags to add deps.. and/or browserify config file? or parse require.js config file? or ??
  b.add('/Users/jessekeane/vagrant/airship/airship/airship/static/js/behaviors/jquery.stream')
  b.add('/Users/jessekeane/vagrant/airship/airship/airship/static/js/behaviors/plateloader')
